              ...
              <FieldGroup className="flex flex-row justify-center">
                <FieldSet className="flex flex-row items-center gap-2">
                  ...
                  <form.Field name={`questions[${questionIndex}].trueLabel`}>
                    {(trueLabelField) => {
                      const isInvalid =
                        trueLabelField.state.meta.isTouched && !trueLabelField.state.meta.isValid
                      return (
                        <Field>
                          <Input
                          ...
                          />
                          {isInvalid && <FieldError errors={trueLabelField.state.meta.errors} />}
                        </Field>
                      )
                    }}
                  </form.Field>
                ...
                <FieldSet className="flex flex-row items-center gap-2">
                  ...
                  <form.Field name={`questions[${questionIndex}].falseLabel`}>
                    {(falseLabelField) => {
                      const isInvalid =
                        falseLabelField.state.meta.isTouched && !falseLabelField.state.meta.isValid
                      return (
                        <Field>
                          <Input
                          ...
                          />
                          {isInvalid && <FieldError errors={falseLabelField.state.meta.errors} />}
                        </Field>
                      )
                    }}
                  </form.Field>
